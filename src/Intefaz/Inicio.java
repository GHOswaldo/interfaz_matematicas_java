...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Matemáticas básicas");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tw Cen MT", 1, 24)); // NOI18N
        jLabel1.setText("CONCEPTOS DE MATEMÁTICAS BÁSICAS");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/INICIO.png"))); // NOI18N

        jLabel3.setText("Una recopilación de conceptos elementales y útiles en las matemáticas.");
